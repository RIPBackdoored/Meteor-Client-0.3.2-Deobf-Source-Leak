...
public enum Mode
{
    ...
    static {
        Mode.ENCRYPTED_STRINGS = new String[] { "Lines", "Sides", "Both", "Outline" };
        Mode.Lines = new Mode("Lines", 0);
        Mode.Sides = new Mode("Sides", 1);
        Mode.Both = new Mode("Both", 2);
        Mode.Outline = new Mode("Outline", 3);
        Mode.$VALUES = new Mode[] { Mode.Lines, Mode.Sides, Mode.Both, Mode.Outline };
    }
}
